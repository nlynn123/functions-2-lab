...
const multiply = (num1, num2, callBackName) => {
...
*/
 const first = (arr, callBackFunction) => {
  return callBackFunction(arr[0])
 }
...
const last = (arr, callBackName) => {
  return callBackName(arr[arr.length-1])
}
// UNCOMMENT THE FUNCTION CALL BELOW
// RUN THIS FILE WITH NODE
// CHECK YOUR ANSWER
...
// CODE HERE 
let namesArray = ['Harry', 'Hermione', 'Ron', 'Neville', 'Ginny']

// namesArray.forEach((elem, i) => console.log(`The item at index ${i} is ${elem}`))
